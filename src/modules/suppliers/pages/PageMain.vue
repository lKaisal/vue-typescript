<template lang="pug">
  ...
  +b.page-main.page
    +e.container(v-if="list.data && list.data.length")
      ...
      PaginationApp(:total="listSortedAndFiltered && listSortedAndFiltered.length" :pageSize="pageSize" :pagerCount="pagPagerCount" @currentChange="onCurrentChange" @pageSizeChange="onPageSizeChange"
