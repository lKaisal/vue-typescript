<template lang="pug">
  ...
  +b.list-suppliers
    +e.container
      ...
      //-   //- table body
      //-   ItemNews(v-for="(item, index) in list" :key="index" :titleIsShown="isLtMd" :supplier="item" :fields="fields" :widths="minWidths"
...
export default class ListNews extends Mixins(NewsMappers, UiMappers, MsgBoxToolsApp, MsgBoxTools) {
  ...
  get fields(): TableField[] { return [
    // { field: 'supplierId', title: 'NewsID', isWidthCalculable: true, isSortable: true, isSmall: this.isLg || this.isMd, isMedium: this.isXl, isCentered: true },
